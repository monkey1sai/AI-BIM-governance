...
This project is indexed by GitNexus as **AI-BIM-governance** (9974 symbols, 23335 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/AI-BIM-governance/process/{processName}` — trace the full execution flow step by step
...
| Work in the 1.104.1_0 area (3454 symbols) | `.claude/skills/generated/1-104-1-0/SKILL.md` |
| Work in the App area (112 symbols) | `.claude/skills/generated/app/SKILL.md` |
| Work in the {{python_module_path}} area (75 symbols) | `.claude/skills/generated/python-module-path/SKILL.md` |
| Work in the Tests area (60 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Clients area (52 symbols) | `.claude/skills/generated/clients/SKILL.md` |
| Work in the 1.0.0.6_0 area (48 symbols) | `.claude/skills/generated/1-0-0-6-0/SKILL.md` |
...
| Work in the Messaging area (18 symbols) | `.claude/skills/generated/messaging/SKILL.md` |
| Work in the Packman area (14 symbols) | `.claude/skills/generated/packman/SKILL.md` |
| Work in the Components area (12 symbols) | `.claude/skills/generated/components/SKILL.md` |
| Work in the Cluster_25 area (10 symbols) | `.claude/skills/generated/cluster-25/SKILL.md` |
| Work in the Cluster_27 area (10 symbols) | `.claude/skills/generated/cluster-27/SKILL.md` |
| Work in the Types area (9 symbols) | `.claude/skills/generated/types/SKILL.md` |
...
| Work in the Bootstrap area (7 symbols) | `.claude/skills/generated/bootstrap/SKILL.md` |
| Work in the Cluster_32 area (6 symbols) | `.claude/skills/generated/cluster-32/SKILL.md` |
| Work in the Get area (5 symbols) | `.claude/skills/generated/get/SKILL.md` |
