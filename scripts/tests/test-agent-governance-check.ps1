...
try {
    ...
    Assert-True ($governanceWorkflow -match 'node --test scripts/tests/test-cleanup-orphan-dev-processes\.mjs scripts/tests/test-manage-pr-queue\.mjs scripts/tests/test-pr-queue-adversarial-and-stress\.mjs scripts/tests/test-autonomous-delivery-finalization\.mjs') 'agent-governance workflow runs orphan cleanup, named PR queue, and autonomous finalization tests'
