...
try {
    ...
    Assert-True ($governanceWorkflow -match 'node --test scripts/tests/test-cleanup-orphan-dev-processes\.mjs scripts/tests/test-manage-pr-queue\.mjs scripts/tests/test-pr-queue-adversarial-and-stress\.mjs scripts/tests/test-autonomous-delivery-finalization\.mjs scripts/tests/test-linux-continuous-deployment\.mjs') 'agent-governance workflow runs orphan cleanup, named PR queue, autonomous finalization, and Linux continuous deployment tests'
