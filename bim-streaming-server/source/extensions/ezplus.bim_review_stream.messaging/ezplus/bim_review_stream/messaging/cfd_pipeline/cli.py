...
def cmd_preprocess(args: argparse.Namespace) -> int:
    stats = run_preprocess(
        ...
        leak_fraction_limit=args.leak_limit,
    )
...
def cmd_run_case(args: argparse.Namespace) -> int:
    ...
    end_time = int(meta.get("params", {}).get("end_time") or CaseParams.end_time)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pre.add_argument("--leak-limit", type=float, default=None, help="sealing leak_fraction_limit; default = the profile value")
    ...
    case.add_argument("--uref", type=float, default=CaseParams.uref_m_s)
    case.add_argument("--zref", type=float, default=CaseParams.zref_m)
    case.add_argument("--z0", type=float, default=CaseParams.z0_m)
    case.add_argument("--ground-z", type=float, default=CaseParams.ground_z_m)
    case.add_argument("--cell", type=float, default=CaseParams.background_cell_m)
    case.add_argument("--surface-level", type=int, default=CaseParams.surface_refinement_level)
    ...
    batch.add_argument("--uref", type=float, default=CaseParams.uref_m_s)
    batch.add_argument("--zref", type=float, default=CaseParams.zref_m)
    batch.add_argument("--z0", type=float, default=CaseParams.z0_m)
    batch.add_argument("--ground-z", type=float, default=CaseParams.ground_z_m)
    batch.add_argument("--cell", type=float, default=CaseParams.background_cell_m)
    batch.add_argument("--surface-level", type=int, default=CaseParams.surface_refinement_level)
    batch.add_argument("--region-level", type=int, default=CaseParams.region_refinement_level)
    ...
    conv.add_argument("--uref", type=float, default=CaseParams.uref_m_s)
    conv.add_argument("--zref", type=float, default=CaseParams.zref_m)
    conv.add_argument("--z0", type=float, default=CaseParams.z0_m)
    conv.add_argument("--ground-z", type=float, default=CaseParams.ground_z_m)
    conv.add_argument("--surface-level", type=int, default=CaseParams.surface_refinement_level)
    conv.add_argument("--region-level", type=int, default=CaseParams.region_refinement_level)
    conv.add_argument("--end-time", type=int, default=CaseParams.end_time)
    conv.add_argument("--np", type=int, default=CaseParams.n_procs)
    ...
    aij.add_argument("--surface-level", type=int, default=CaseParams.surface_refinement_level)
    aij.add_argument("--region-level", type=int, default=CaseParams.region_refinement_level)
    aij.add_argument("--end-time", type=int, default=CaseParams.end_time)
    aij.add_argument("--np", type=int, default=CaseParams.n_procs)
