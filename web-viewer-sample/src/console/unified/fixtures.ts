...
export function getL(zh: boolean): Dict {
  return zh ? {
    ...
    nav_home: "總覽", nav_ws: "3D 工作區", nav_pipe: "生產線狀態", nav_ops: "Runtime / Kit·GPU",
    ...
    pipe_title: "生產線狀態", st_intake: "進件", st_conv: "轉檔", st_callback: "回拋",
    ...
    nav_home: "Overview", nav_ws: "3D Workspace", nav_pipe: "Pipeline status", nav_ops: "Runtime / Kit·GPU",
    ...
    pipe_title: "Pipeline status", st_intake: "Intake", st_conv: "Convert", st_callback: "Callback",
