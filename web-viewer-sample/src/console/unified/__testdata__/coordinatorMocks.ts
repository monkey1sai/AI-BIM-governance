...
export const RT_IDLE: RuntimeStatus = {
  service: { status: "ok", name: "bim-review-coordinator", uptime_seconds: 1, generated_at: "2026-08-25T00:00:00Z" },
  ...
  observations: { classification: "coordinator_visible_runtime_summary", note: "", web_plane: { coordinator_port: 8004, viewer_port: 5173 }, host_native_plane: { conversion_api_base: "", kit_signal_ports: [49100], kit_media_ports: [47998] } },
};
...
export function sessionItem(id: string, status: RuntimeSessionSummary["status"] = "active"): RuntimeSessionSummary {
