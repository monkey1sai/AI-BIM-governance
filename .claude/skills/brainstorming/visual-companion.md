...
Run every shell command in this guide from the skill directory that contains this file. From the repository root, enter `.codex/skills/brainstorming` for Codex or `.claude/skills/brainstorming` for Claude Code before starting the server.

```bash
# Codex from repository root (use .claude/skills/brainstorming for Claude Code)
cd .codex/skills/brainstorming
