...
| `building-energy-cfd.md`、`building-energy-cfd-p2-contract.md` | 建築風場 CFD：分期、實測紀錄與 P2 總表（§6）、剩餘工作與完成條件（§10）；P2 契約（方向 A，payload 以 `tests/contracts/cfd-run-*-v1.schema.json` 為準）與切片 S0–S7。P2 戶外風場已在 181 驗證，精度 `screening` |
<!-- canon:r-file-table -->
