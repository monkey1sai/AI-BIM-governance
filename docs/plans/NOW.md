...
> **2026-07-30 PR #431 final hardening：** immutable code subject `ac2c45101afaade40f3ad24e58b4a7f6ab39ab5f` 已含 `origin/main` `243d9647190d2dbd84c60de6282e9bb15815c2f5`（merge `ba6664a`）。final reviewer `ACCEPT`（P1/P2/P3=0）；A3+A4 evidence scope、viewer preflight、cross-process reservation/ABA、strict malformed fail-closed、listener→inventory→listener stale proof、deleted-worktree shared residue reclaim 與 manifest-first recovery 均有回歸測試。PowerShell contract/static、targeted Vitest 60/60、viewer verify 78 files／956 tests、`git diff --check` 通過。GitNexus index stale at `8b34c8e`，detect 為 low／0 process，不宣稱 impact pass。30/33 tasks；4.3、5.2、5.3 與無成功 A4 manifest／PNG／runtime ID 維持 known gap，未在此 code subject 後重跑真實 browser/runtime smoke。
