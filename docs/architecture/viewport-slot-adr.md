...
1. `cd web-viewer-sample && npx vitest run src/console/unified src/console/ReviewSessionViewerPane.test.tsx src/console/A1ViewerEmbed.test.tsx src/console/WorkspaceFlowGuide.test.tsx` and `npx tsc --noEmit`.
