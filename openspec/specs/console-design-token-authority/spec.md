# console-design-token-authority Specification

## Purpose
TBD - created by archiving change migrate-console-to-hifi-design. Update Purpose after archive.
## Requirements
...
#### Scenario: frozen deferred 不阻塞視覺遷移

- **WHEN** `align-frontend-design-system-reference` 為 frozen deferred，且其 tasks 2.4–2.8 未完成
