# edge-console-operator-frontend — Spec Delta (edge-console-shell)

> 新 capability：落地端操作員前端（Edge Console），以 06 骨架落地於真實 `web-viewer-sample`。
> 誠實原則、雲地邊界、A1 可在介面驗證、A2/A3 骨架。
