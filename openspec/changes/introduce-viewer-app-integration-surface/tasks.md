...
- [ ] 0.1 四份 artifact（proposal／design／tasks／`specs/viewer-app-integration-surface/spec.md`）落 `openspec/changes/introduce-viewer-app-integration-surface/`，`npx openspec validate introduce-viewer-app-integration-surface --strict` 通過。
