# usd-federation-sublayer-sets — Spec Delta (a3-transform-review-room)

> 對既有 capability `usd-federation-sublayer-sets` 新增 per-member transform 與 Review Room handoff。
