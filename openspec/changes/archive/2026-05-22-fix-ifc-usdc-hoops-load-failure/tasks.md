...
- [x] 12.4 Wait for CI/review and merge.
- [x] 12.5 Archive only after PR #101 is merged and real runtime conversion + viewer evidence remains valid on synced `main`.
- [x] 12.6 Sync roadmap Markdown and HTML if archive is performed.
