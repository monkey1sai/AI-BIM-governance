# usd-federation-composition — Spec Delta (usd-federation-sublayer-sets)

> 新 capability：落地端以 OpenUSD sublayer 疊合多個 discipline USD 成 federated stage。CPU pxr authoring，member usdc immutable。
