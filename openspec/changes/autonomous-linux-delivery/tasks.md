...
- [x] 6A.3 實作environment＋service single-flight、active idempotent replay停止、主路徑retry enforcement、per-state digest-chained ledger與outer attempt append validation。
