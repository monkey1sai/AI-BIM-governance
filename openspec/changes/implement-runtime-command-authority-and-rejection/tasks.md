...
- [ ] 5.6 將viewer origin完整失敗態矩陣接到既有i18n keys；本切片已收斂runtime-command-rejection diagnostics、changed-unconfirmed binding與rejected stage-load。stage-load-timeout及其餘失敗態仍須逐態驗證，因此production/full completion維持no
