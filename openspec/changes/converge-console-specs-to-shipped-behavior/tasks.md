...
- [ ] 1.2 「harness／無 GPU 時中央視區顯示資訊而非空白」收斂（稽核 L423）
- [ ] 1.3 「Operator opens the product console」收斂（稽核 L478）
- [ ] 1.4 「Operator opens A1」收斂（稽核 L495；與 2.2 同源＝IA v2 把 a1/a2/a3 讓給 UnifiedConsole workspace）
