...
| 開 PR / Actions / branch closeout；Cloud task → same-repo PR → ephemeral local validation → protected-main deploy | `docs/agents/github-workflow.md`；`docs/agents/codex-cloud-local-pipeline.md` |
